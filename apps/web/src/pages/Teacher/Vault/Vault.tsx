          ...
          <div className="card p-6 flex items-center justify-between">
            <div>
              <h1 className="heading-md flex items-center gap-2">
                <i className="pi pi-folder-open text-brand-orange text-xl" /> Classroom Vault
              </h1>
              <p className="text-text-muted text-xs mt-1">
                Access your classroom's round-by-round AI summaries, learning slides, and lesson resource recommendations.
              </p>
            </div>
            <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {reports.map((report) => (
                <Card
                  ...
                  className="hover:shadow-md transition-shadow border border-ui-border bg-ui-surface cursor-pointer hover:border-brand-orange/50"
                ...
                >
                  ...
                  <div className="flex items-center justify-between mt-2 pt-2 border-t border-ui-border">
                    <span className="text-xs text-brand-orange font-medium flex items-center gap-1">
            ...
            >
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                <div className="lg:col-span-5 space-y-6">
                  <div>
                    <h3 className="text-sm font-semibold uppercase text-brand-orange tracking-wider mb-2">Round Summary</h3>
                  ...
                  <div>
                    <h3 className="text-sm font-semibold uppercase text-brand-orange tracking-wider mb-2">Common Mistakes</h3>
                ...
                <div className="lg:col-span-7 flex flex-col">
                  <h3 className="text-sm font-semibold uppercase text-brand-orange tracking-wider mb-2 flex items-center justify-between">
                  ...
                  <div className="flex-grow bg-slate-900 text-slate-100 rounded-xl p-6 shadow-lg border border-slate-800 min-h-[320px] flex flex-col justify-between">
                    <div>
                      {/* Slide Title */}
                      <h4 className="text-xl font-bold text-brand-orange mb-4 pb-2 border-b border-slate-800">
                  ...
                  <div className="flex items-center justify-between mt-4">
                    ...
                    <Button
                      ...
                      className="px-4 py-2 text-sm bg-brand-orange text-brand-dark font-semibold rounded-lg"
                    />
                  </div>
                </div>
              </div>
