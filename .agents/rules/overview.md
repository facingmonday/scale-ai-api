...
# SCALE LXP — Application Overview & Design Summary

## Purpose

SCALE LXP is a learning-focused supply chain simulation platform designed for college-level Supply Chain 101 courses. It uses a pizza shop game to teach students core operational concepts such as demand forecasting, capacity planning, inventory management, environmental risk, and decision-making under uncertainty.
...
SCALE LXP provides a lightweight but powerful simulation that:
