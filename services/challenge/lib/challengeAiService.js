      ...
      messages: [
        {
          ...
          content: [
            ...
            "OUTCOME GENERATION RULES:",
            "- Treat the outcome as shared realized conditions for the challenge, not as a precomputed result for every store.",
            "- Put student-visible shared conditions in outcome.notes. Appropriate facts include market direction, supplier availability, rush premiums, platform commissions, payment delays, weather, transportation, contract terms, and other external conditions.",
            "- Preserve exact values from the instructor source only when they are genuinely shared external facts. Do not turn an overall engagement count, forecast, or market condition into identical store-level conversion, demand, accepted orders, sales, revenue, costs, or profit.",
            "- State that store-level opportunities or effects are uneven when appropriate. Leave each store's realized demand, fulfillment, sales, costs, and profit to its profile type, customer fit, student decisions, inventory, production capacity, cash, and channel participation.",
            "- Student forecasts and estimates may affect preparation, but they never determine realized demand or other actual conditions.",
            "- Never prescribe results that bypass or conflict with configured profile capacity, financial settings, inventory, or metric rules.",
            "- Write outcome.notes as 1 to 3 short prose paragraphs separated by a blank line, with no heading, label, bullets, numbering, or markdown.",
            "- Use outcome.hiddenNotes only for authoritative instructor-only external facts that the simulation needs and students should not see. Do not put per-store formulas, fixed student results, capacity overrides, or instructions to copy student forecasts into hidden notes. Set hiddenNotes to an empty string when no private fact is necessary.",
