# SCALE.ai Information Security Policy
...
**Applies to:** SCALE.ai personnel, contractors, systems, services, production environments, and third parties with authorized access to SCALE.ai data or systems

## 1. Purpose

This Information Security Policy defines the administrative, technical, and operational safeguards used to protect SCALE.ai systems and data. It is intended to support institutional security reviews, including the Higher Education Community Vendor Assessment Toolkit (HECVAT), by documenting how SCALE.ai governs information security, protects customer data, manages risk, and responds to security events.

SCALE.ai is a classroom-based supply chain simulation platform. The platform supports instructors and students through class management, scenario configuration, student submissions, AI-assisted simulation processing, ledger generation, dashboards, and email notifications.

## 2. Scope

This policy applies to:

- Production, staging, development, and administrative systems that support SCALE.ai.
...
- Employees, contractors, service providers, and vendors who access SCALE.ai systems or data.

The current SCALE.ai technical environment includes Node.js, Express, MongoDB, Clerk, SendGrid, OpenAI, Bull/Redis queues, Docker, and DigitalOcean App Platform.

## 3. Security Governance

SCALE.ai maintains an information security program appropriate to the size, maturity, and risk profile of the organization. Security responsibilities are assigned to designated leadership responsible for:
...
SCALE.ai performs risk management activities to identify, evaluate, and address risks to confidentiality, integrity, availability, and privacy. Risk management activities include:
...
SCALE.ai classifies data based on sensitivity and business impact. At minimum, SCALE.ai recognizes the following data categories:
...
Access to SCALE.ai systems and data is granted based on least privilege, role-based need, and authorization by appropriate personnel.

SCALE.ai access control requirements include:
...
SCALE.ai uses Clerk for user authentication and organization membership management. Application authorization is enforced by backend services and middleware that validate identity, organization scope, class membership, and role permissions before allowing access to protected resources.
...
SCALE.ai protects data in transit and at rest using encryption appropriate to the system and data sensitivity.
...
SCALE.ai follows secure software development practices for application and infrastructure changes. Engineering practices include:
...
SCALE.ai manages changes to production systems to reduce the risk of unauthorized, untested, or disruptive modifications.
...
SCALE.ai identifies and remediates vulnerabilities in application code, dependencies, infrastructure, and third-party services using a risk-based approach.
...
SCALE.ai maintains logs to support troubleshooting, security monitoring, auditability, and incident investigation. Logging practices should balance operational needs with data minimization and privacy requirements.
...
SCALE.ai maintains an incident response process for identifying, triaging, containing, investigating, remediating, and communicating security incidents.
...
SCALE.ai maintains practices intended to preserve service availability and recover from disruptions affecting critical systems.
...
SCALE.ai retains data only as long as needed for educational, operational, contractual, legal, security, or support purposes.
...
SCALE.ai is designed for educational use and may process student, instructor, class, organization, and simulation data. SCALE.ai protects personal data through access controls, purpose limitation, data minimization, and contractual safeguards.
...
SCALE.ai uses OpenAI to calculate simulation outcomes based on store configuration, scenario data, outcome data, student submissions, and ledger history. AI processing is used to support educational simulation outcomes and narrative feedback.
...
SCALE.ai relies on third-party service providers for hosting, authentication, email delivery, database or infrastructure services, AI processing, development tooling, and related business operations.
...
SCALE.ai personnel and contractors with access to company systems or customer data must understand and follow security responsibilities.
...
Personnel devices used to access SCALE.ai systems must be protected against unauthorized access and compromise.
...
SCALE.ai uses managed hosting and platform services to reduce infrastructure management risk. Infrastructure security expectations include:
...
SCALE.ai maintains backup and restoration practices for critical data based on provider capabilities and business requirements.
...
Personnel must use SCALE.ai systems, data, devices, and accounts responsibly and only for authorized business purposes.
...
SCALE.ai primarily relies on managed cloud and platform providers for physical security of production infrastructure. Provider physical security controls are evaluated as part of vendor risk management.
...
SCALE.ai supports customer and institutional security reviews, including HECVAT, by maintaining security documentation and providing reasonable evidence of implemented controls.
...
SCALE.ai will review institutional security requirements and contractual obligations before committing to additional controls, certifications, data processing terms, or service-level obligations.
...
This policy must be reviewed at least annually and when material changes occur to SCALE.ai systems, vendors, data processing activities, security risks, or legal and contractual obligations. Updates must be approved by designated leadership and communicated to affected personnel.
