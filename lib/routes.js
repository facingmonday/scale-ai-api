const { gradebookAvailable } = require("./gradingSettings");
...
const getUsersRoutes = ({
  ...
  return [
    ...
    classroomRequired(
      isOrgAdmin && gradebookAvailable() && {
        type: "item", name: "Gradebook", key: "gradebook",
        route: "/gradebook", pageKey: "gradebook", icon: "assessment",
      },
    ),
