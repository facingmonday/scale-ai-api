...
function loadComponent(templateSlug) {
  ...
  switch (templateSlug) {
    case "decision-receipt":
      return require("./templates/DecisionReceiptEmail.jsx").DecisionReceiptEmail;
    case "challenge-reminder":
      return require("./templates/ChallengeReminderEmail.jsx").ChallengeReminderEmail;
    case "challenge-announcement":
      return require("./templates/ChallengeReminderEmail.jsx").ChallengeAnnouncementEmail;
    case "challenge-created":
      templateModule = require("./templates/ChallengeCreatedEmail.jsx");
      return templateModule.ChallengeCreatedEmail || templateModule;
    case "challenge-closed":
      templateModule = require("./templates/ChallengeClosedEmail.jsx");
      return templateModule.ChallengeClosedEmail || templateModule;
    default:
...
async function renderReactEmail(templateSlug, props = {}) {
  ...
  // Pretty-printing inserts whitespace into pre-wrapped student answers.
  const html = await render(element, { pretty: templateSlug !== "decision-receipt" });
