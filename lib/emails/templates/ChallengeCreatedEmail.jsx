...
function ChallengeCreatedEmail(props) {
  ...
  const previewText = `New Challenge Available - ${challenge.title || "Challenge"}`;
  const host = env.SCALE_ADMIN_HOST || "https://localhost:5173";
  const scenarioLink =
    link ||
    challenge?.link ||
    `${host}/class/${classroom._id || ""}/challenge/${challenge._id || ""}`;
        ...
        >
          ...
          >
            ...
            <Section style={{ padding: "30px" }}>
              ...
              >
                A new challenge has been added to{" "}
              ...
              >
                ...
                <Text style={{ margin: "8px 0 0 0", fontSize: "14px" }}>
                  Review the challenge details and prepare your decision.
...
module.exports = {
  ChallengeCreatedEmail,
  populatePaths: ["classroom", "challenge"],
};
