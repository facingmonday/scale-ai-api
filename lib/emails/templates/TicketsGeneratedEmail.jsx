...
function TicketsGeneratedEmail(props) {
  const {
    order = {},
    event = {},
    organization = {},
  ...
  const previewText = `Your Tickets Are Ready - ${event.title || "Event"}`;
                              ...
                              >
                                <div>
                                  ...
                                  {t?.attendeeInfo?.name ? (
                                    ...
                                    >
                                      Attendee: {t.attendeeInfo.name}
                                    </div>
                                  ) : null}
                                  {Array.isArray(t?.selectedOptions) &&
                                  t.selectedOptions.length > 0 ? (
                                    ...
                                    >
                                      {t.selectedOptions.map((opt, j) => (
                                        <span key={j}>
                                          {opt?.ticketTypeOption?.name}:{" "}
                                          {opt?.value === true
                                            ? "Yes"
                                            : opt?.value === false
                                            ? "No"
                                            : opt?.value}
                                          {j < t.selectedOptions.length - 1
                                            ? ", "
                                            : ""}
                                        </span>
                                      ))}
