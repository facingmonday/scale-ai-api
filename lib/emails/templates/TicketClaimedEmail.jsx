...
function TicketClaimedEmail(props) {
  const { event = {}, ticket = {}, member = {}, env = {} } = props || {};
  const previewText = `Your Ticket is Ready - ${event.title || "Event"}`;
        ...
        >
          ...
          >
            ...
            <Section style={{ padding: "24px 32px", color: "#111" }}>
              ...
              <Text>
                Your ticket for <strong>{event.title}</strong> has been
                successfully claimed and is ready for download.
              </Text>
              ...
              >
                <tbody>
                  <tr>
                    ...
                    <td style={{ textAlign: "center", padding: "0 6px" }}>
                      <Button
                        href={`${host}/apple-wallet?ticketId=${
                          ticket?._id || ""
                        }`}
                        style={{
                          display: "inline-block",
                    ...
                    <td style={{ textAlign: "center", padding: "0 6px" }}></td>
                  </tr>
                </tbody>
              </table>
            ...
            >
              ...
              <Text style={{ margin: "6px 0" }}>
                If you did not claim this ticket, please contact us immediately.
              </Text>
              <Text style={{ margin: "6px 0" }}>
                <small>
                  Ticket claimed on {formatDateTime(ticket?.updatedDate)}
                </small>
              </Text>
            </Section>
          </Container>
